...
export default function CalculatorSection() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-2 sm:px-4 py-6 sm:py-8 md:py-12">
      <style>{`
        .calc-input:focus {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 shadow-xl mb-6 sm:mb-8">
        <div className="text-center">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4" style={{ color: "#ffd230" }}>
            Калькулятор вкладов
          </h1>
        </div>
          <div className="space-y-4 sm:space-y-6">
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="calc-input w-full px-3 sm:px-4 py-3 sm:py-4 pr-16 sm:pr-20 md:pr-24 rounded-xl border-2 border-gray-200 text-base sm:text-lg focus:outline-none"
                  min="0"
                />
                <span className="absolute right-3 sm:right-4 top-1/2 -translate-y-1/2 text-xs sm:text-sm text-gray-500">
                  сомони
                </span>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="calc-input w-full px-3 sm:px-4 py-3 sm:py-4 pr-14 sm:pr-16 md:pr-20 rounded-xl border-2 border-gray-200 text-base sm:text-lg focus:outline-none"
                  min="1"
                />
                <span className="absolute right-3 sm:right-4 top-1/2 -translate-y-1/2 text-xs sm:text-sm text-gray-500">
                  дней
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="calc-button-primary flex-1 px-6 sm:px-8 py-3 sm:py-4 bg-amber-300 hover:bg-amber-400 text-gray-900 rounded-xl font-semibold text-sm sm:text-base md:text-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all"
              >
              ...
              {calculated && (
                <button
                  onClick={handleReset}
                  className="calc-button-secondary px-4 sm:px-6 py-3 sm:py-4 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl font-semibold text-sm sm:text-base transition-all"
                >
                  Сбросить
                </button>
              )}
...
function ResultCard({
  ...
  return (
    <div
      className={`calc-card bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg relative ${
        recommended ? "calc-card-recommended border-2 border-amber-300" : "border-2 border-transparent"
      }`}
    >
      {recommended && (
        <div className="absolute -top-2 sm:-top-3 -right-2 sm:-right-3 bg-amber-300 px-2 sm:px-4 py-1 sm:py-1.5 rounded-full text-xs font-bold text-gray-900 flex items-center gap-1 shadow-lg">
          <span>⭐</span>
          <span className="hidden sm:inline">Рекомендуется</span>
      ...
      <div className="mb-4 sm:mb-6 pb-3 sm:pb-4 border-b border-gray-100">
        <div className="flex items-center justify-between mb-2 flex-wrap gap-2">
          ...
          {rate !== undefined && (
            <div className="bg-indigo-500 text-white px-2 sm:px-3 py-1 rounded-lg text-xs sm:text-sm font-bold">
              {rate}%
            </div>
          )}
        </div>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <p className="text-xl sm:text-2xl font-bold text-gray-900 mt-1">{income}</p>
        </div>
        ...
        <div>
          ...
          <p className="text-2xl sm:text-3xl font-bold text-indigo-600 mt-1">{total}</p>
        </div>
      </div>
    </div>
  );
